...
public class probarAnalizadorLexico extends JFrame implements ActionListener{
   ...
   private JButton boton,botonAnalizar,botonGuardar;
    ...
    private HashSet<Transicion> Trans1 = new HashSet<Transicion>();
     ...
     public probarAnalizadorLexico(AFN AFN1){
        AFNAux = AFN1;
        setLayout(null);
...
//Cuadro de texto ----------------------------------------------------------
        JLabel Id;
         ...
         JLabel etiquetaConvertir = new JLabel("Cargar AFD desde archivo");
        etiquetaConvertir.setBounds(30,10,300,30); 
...
//Boton seleccionar----------------------------------------------------------
 JLabel utilizar = new JLabel("AFN a utilizar");
    ...
    public void opciones(AFN AFN1){
       probarAnalizadorLexico uno = new probarAnalizadorLexico(AFN1);
